...
지금까지 만든 모델을 사용하여 현직 데이터사이언티스트 교수님이 유퀴즈에 나왔을때의 조회수와 시청율을 예측해 보도록 하였습니다
...
- 각 수치들이 학회 및 연구 별로 다양한 방법으로 범주화를 적용하고 있습니다. 우리는 그중 하나의 방법으로만 적용해 보았는데, 다양한 기준점을 갖고 값을 그룹화했었으면 어땠을까 하는 아쉬움이 남았습니다.
